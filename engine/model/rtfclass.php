	...
	class rtf {
		...
		*/
		function flushSpecial( $special) {
			if( strlen( $special) == 2) {
				if( $this->wantXML)
					$this->out .= "<span class=\"special\" value=\"".$special."\"/>";
				if( $this->wantHTML){
					$this->out .= "<span class=\"special\" value=\"".$special."\"/>";
					switch( $special) {
                                            case "a1": $this->out .= "&#161;"; break;
                                            case "a7": $this->out .= "&#167;"; break; // pargraph
                                            ...
                                            case "e7": $this->out .= "&#231;"; break; // ç
                                            case "e8": $this->out .= "&#232;"; break; // è
                                            case "e9": $this->out .= "&#233;"; break; // é
                                            case "ea": $this->out .= "&#234;"; break; // é
                                            case "eb": $this->out .= "&#235;"; break; // é
                                            case "ec": $this->out .= "&#236;"; break;
                                            case "ed": $this->out .= "&#237;"; break; // í
