<div class="navbar navbar-default navbar-static-top header">
    <img src="/styles/images/logo.png" alt="" class="img-responsive logo pull-left" />
	
    <div class="btn-group pull-right user">
        <span type="button" class="btn dropdown-toggle" data-toggle="dropdown">{$inf->name}<span class="caret"></span></span>
