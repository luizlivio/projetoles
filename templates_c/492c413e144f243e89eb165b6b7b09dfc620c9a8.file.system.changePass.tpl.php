<?php /* Smarty version Smarty-3.1.13, created on 2019-06-28 11:02:19
...
<div class="step">
    <form method="post" action="/info/<?php if ($_smarty_tpl->tpl_vars['inf']->value->mult!=''){?>alterPassMult<?php }else{ ?>alterPass<?php }?>" id="alterarSenha">
        ...
        <div class="alert alert-info">
            <strong>Atenção</strong> só serão aceito senhas númericas de 6 a 10 dígitos
        </div>
