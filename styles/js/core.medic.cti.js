    ...
    $(".query").keyup(function () {
        ...
        if (field.val().length > 5) {
            ...
            setTimeout(function () {
                ...
                $.getJSON("/medic/GerarPacientes?q=" + field.val() + "", function (data) {
                    ...
                    $.each(data, function (key, val) {
                        items.push("<a href='/medic/Pesquisa/" + val.id + "' class='spr'>" + val.nome + "</a>");
                    });
...
function validaridentificacao(elem)
{        
 
 
    if (elem.nome.value == "")
                    {
                            alert("Erro: Insira o nome do Paciente!");
                            elem.local.focus();
                            return false;
                    }
}
